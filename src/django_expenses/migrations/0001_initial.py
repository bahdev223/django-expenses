...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"verbose_name": "Cost center", "verbose_name_plural": "Cost centers", "ordering": ["code"]},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=200)),
                ("description", models.TextField(blank=True)),
                ("expense_nature", models.CharField(blank=True, choices=[("operating", "Fonctionnement"), ("investment", "Investissement"), ("mission", "Mission"), ("purchase", "Achat"), ("payroll", "Personnel"), ("other", "Autre")], help_text="Nature of expense: operating, investment, mission, purchase...", max_length=20)),
                ("default_account_code", models.CharField(blank=True, help_text="Default OHADA account code (e.g. 6251 for fuel)", max_length=20)),
                ("default_vat_rate", models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ("color", models.CharField(blank=True, help_text="Hex color for UI (e.g. #FF5733)", max_length=7)),
                ("icon", models.CharField(blank=True, help_text="Icon name for UI", max_length=50)),
                ("sort_order", models.IntegerField(default=0)),
                ("is_active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("parent", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name="children", to="django_expenses.expensecategory")),
            ],
            options={"verbose_name": "Expense category", "verbose_name_plural": "Expense categories", "ordering": ["sort_order", "code"]},
        ),
        migrations.CreateModel(
            name="Expense",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("expense_nature", models.CharField(blank=True, choices=[("operating", "Fonctionnement"), ("investment", "Investissement"), ("mission", "Mission"), ("purchase", "Achat"), ("payroll", "Personnel"), ("other", "Autre")], help_text="Nature: operating, investment, mission, purchase...", max_length=20)),
                ("status", models.CharField(choices=[("draft", "Brouillon"), ("submitted", "Soumise"), ("pending_approval", "En attente d'approbation"), ("approved", "Approuv\u00e9e"), ("rejected", "Rejet\u00e9e"), ("paid", "Pay\u00e9e"), ("archived", "Archiv\u00e9e"), ("cancelled", "Annul\u00e9e")], db_index=True, default="draft", max_length=20)),
                ...
                ("payment_method", models.CharField(blank=True, choices=[("cash", "Esp\u00e8ces"), ("check", "Ch\u00e8que"), ("bank_transfer", "Virement bancaire"), ("mobile_money", "Mobile Money"), ("card", "Carte bancaire"), ("other", "Autre")], max_length=20)),
                ...
                ("category", models.ForeignKey(help_text="Hierarchical expense category with default account code", on_delete=django.db.models.deletion.PROTECT, related_name="expenses", to="django_expenses.expensecategory")),
                ("cost_center", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="expenses", to="django_expenses.costcenter")),
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "Expense comment", "verbose_name_plural": "Expense comments", "ordering": ["created_at"]},
        ),
        migrations.CreateModel(
            name="ExpensePayment",
            fields=[
            ...
            options={"verbose_name": "Expense payment", "verbose_name_plural": "Expense payments", "ordering": ["-payment_date"]},
        ),
    ]
