...
from .serializers import (
    ExpenseListSerializer, ExpenseDetailSerializer, ExpenseWriteSerializer,
    ExpenseCategorySerializer, ExpenseTypeSerializer, CostCenterSerializer,
    ExpenseAttachmentSerializer, ExpenseApprovalSerializer,
    ExpensePaymentSerializer, ExpenseCommentSerializer,
)
...
class ExpenseViewSet(viewsets.ModelViewSet):
    ...
    def _transition(self, request, pk, method, perm=None, **kwargs):
        try:
    ...
    def approve(self, request, pk=None):
        return self._transition(
            request, pk, ExpenseService.approve,
            perm="expenses.approve_expense",
    ...
    def reject(self, request, pk=None):
        return self._transition(
            request, pk, ExpenseService.reject,
            perm="expenses.approve_expense",
    ...
    def pay(self, request, pk=None):
        return self._transition(
            request, pk, ExpenseService.pay,
            perm="expenses.pay_expense",
