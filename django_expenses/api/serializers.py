...
class ExpenseListSerializer(serializers.ModelSerializer):
    ...
    category_name = serializers.CharField(source="expense_type.category.name", read_only=True)
    ...
    class Meta:
        model = Expense
        fields = [
            "id", "reference_number", "status", "status_label", "amount", "tax_amount",
            "total", "currency", "description", "vendor", "date_incurred",
